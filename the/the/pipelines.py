...
class ThePipeline(object):
    ...
    def insert_into_table(self,conn,item):
        conn.execute('insert into th(title,article,des,img,datime,category) values(%s,%s,%s,%s,%s,%s)', (item['title'],item['article'],item['des'],item['img'],item['datime'],item['category']))
