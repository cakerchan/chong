...
class LacPipeline(object):
    ...
    def insert_into_table(self,conn,item):
        conn.execute('insert into content(title,article,des,img,datime,category) values(%s,%s,%s,%s,%s,%s)', (item['title'],item['article'],item['des'],item['img'],item['datime'],item['category']))
